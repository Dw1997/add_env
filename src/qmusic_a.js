...
(() => {
    ...
    this.env_vm.func_set_native = (func) => {
    ...
    function e(t, n, r, i, o, a, u, c) {
        ...
        for (var d = [function () {
            ...
            try {
                ...
                m = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(m); var v = f.pop();
                if (void 0 === v)
                    throw m;
                p = m,
                    t = v[0],
    ...
    return e.v = 5,
        e(0,
            function (e) {
                ...
                [133, 2628, 156, 340, 267, 272, 270, 288, 321, 326, 324, 338, 352, 2575, 786, 790, 788, 869, 904, 908, 906, 944, 945, 949, 947, 983, 991, 995, 993, 1085, 1133, 1217, 1138, 1142, 1140, 1146, 1147, 1151, 1149, 1217, 1336, 1375, 1359, 1369, 1367, 1372, 1376, 1338, 1508, 1547, 1531, 1541, 1539, 1544, 1548, 1510, 1813, 1818, 1816, 2036, 2073, 2078, 2076, 2174, 2172, 2062, 2213, 2218, 2216, 2389, 2387, 2205, 2576, 354]]
            ),
            n)
}();
r.g = function () {
...
var result = window._getSecuritySign(t_data);
console.log(result);
debugger;